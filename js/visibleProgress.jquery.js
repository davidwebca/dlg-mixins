 ...
 */
var visibleProgress = function(el, absolute, absoluteMax, absoluteOffset){
    if(el.length){
        this.el = el;
        this.loaded = false;
        this.rawProgress = 0;
 ...
 */
visibleProgress.previousScrollTop = $(window).scrollTop();
...
visibleProgress.verifyMomentumScroll = function(){
    ...
    if($(window).scrollTop() == visibleProgress.previousScrollTop){
...
$(window).on('touchend', visibleProgress.verifyMomentumScroll);
